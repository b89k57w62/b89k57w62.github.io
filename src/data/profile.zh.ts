  ...
  experience: [
    {
      ...
      summary: '線上娛樂城的全端交付：Vue 3 玩家端 SPA、Rails 後端（報表、金流與遊戲平台串接）、React Native App，以及基於 Discourse 的社群論壇；並在團隊的 Kubernetes (OKE) 環境協助版本發布與部署確認。',
    ...
    },
    {
      ...
      org: '思想科技（台灣分公司）',
      summary: '負責 GCP 雲端概念驗證與正式專案：獨立完成電商文案生成 RAG PoC，協作開發 Hyundai 維修知識庫系統並導入客戶內部使用。',
